public class BreadthFirstSearch extends InteractiveFrame implements Solver {
  ...
  public BreadthFirstSearch( Scene scene, Graph graph, Node source, EventManager eventManager ) {
    super(scene);
    this.graph = graph;
    this.source = source;
